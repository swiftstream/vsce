...
extension RP2040Hardware {
    public var padsBank0: PadsBank {
        PadsBank(unsafeAddress: 0x4001_c000)
    }
    ...
    public struct PadsBank {
        ...
        public struct GPIO {
            ...
            public struct Projection {
                ...
                var encoded: UInt32 {
                    (outputDisable ? 1 << 7 : 0x0) | (inputEnable ? 1 << 6 : 0x0)
                        | driveStrength.encoded | (pullUpEnable ? 1 << 3 : 0x0)
                        | (pullDownEnable ? 1 << 2 : 0x0) | (schmittTriggerEnable ? 1 << 1 : 0x0)
        ...
        public var swclk: SWCLK {
            SWCLK(unsafeAddress: unsafeAddress + 0x0000_00da)
        }
        ...
        public var swd: SWD {
            SWD(unsafeAddress: unsafeAddress + 0x0000_00da)
        }
        ...
        public struct SWD {
            ...
            public func modify<T>(_ apply: (inout Projection) -> T) -> T {
                ...
                RP2040Hardware.write(
                    projection.encoded, to: unsafeAddress | RP2040Hardware.setAliasMask)
                return result
            }
        }
    }
