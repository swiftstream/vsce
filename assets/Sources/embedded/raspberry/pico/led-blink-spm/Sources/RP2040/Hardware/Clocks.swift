...
extension RP2040Hardware {
    public var clocks: Clocks {
        Clocks(unsafeAddress: 0x4000_8000)
    }
        ...
        public struct Reference {
            ...
            public struct Control {
                ...
                public func clearSource() {
                    RP2040Hardware.write(
                        UInt32(0x0000_0001), to: unsafeAddress | RP2040Hardware.clearAliasMask)
                }

                public func clearReference() {
                    RP2040Hardware.write(
                        UInt32(0x0000_0800), to: unsafeAddress | RP2040Hardware.clearAliasMask)
                }
            }
