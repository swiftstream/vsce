...
extension RP2040Hardware {
    public var ioBank0: IOBank {
        IOBank(unsafeAddress: 0x4001_4000)
    }
    ...
    public struct IOBank {
        ...
        public var gpioControl: GPIOControlList {
            GPIOControlList(
                unsafeAddress: unsafeAddress, startOffset: 0x0004, stride: 0x8, count: 30)
        }
            ...
            public struct Projection {
                public enum IRQ: UInt32 {
                    ...
                    init(decoding value: UInt32) {
                        self.init(rawValue: (value & 0x3000_0000) >> 28)!
                    }

                    var encoded: UInt32 {
                        (self.rawValue << 28) & 0x3000_0000
                    }
                }
                ...
                var encoded: UInt32 {
                    irq.encoded | input.encoded | outputEnable.encoded | output.encoded
